...
const App = () => {
  ...
  // Generate data points for the graph (focusing on the visible curves up to 3M for readability)
  const graphData = useMemo(() => {
    const points = [];
    // We generate points to create a smooth line
      ...
      <header className="bg-blue-900 text-white shadow-lg">
        <div className="max-w-5xl mx-auto px-6 py-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Continuity in Taxation</h1>
          </div>
        ...
        {activeTab === 'math' && (
          <div className="space-y-8 animate-in fade-in duration-500">
            <section className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
              ...
              <div className="bg-slate-900 text-slate-100 p-8 rounded-lg font-mono overflow-x-auto shadow-inner">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={graphData} margin={{ top: 20, right: 30, left: 40, bottom: 20 }}>
                      ...
                      <Line 
                        ...
                        activeDot={{ r: 8 }}
                      />
                      {/* Reference Dots for Bracket Boundaries */}
